...
# `nf-core/bulkvariantcalling`: Contributing guidelines

Hi there!
Thanks for taking an interest in improving nf-core/bulkvariantcalling.

This page describes the recommended nf-core way to contribute to both nf-core/bulkvariantcalling and nf-core pipelines in general, including:

- [General contribution guidelines](#general-contribution-guidelines): common procedures or guides across all nf-core pipelines.
- [Pipeline-specific contribution guidelines](#pipeline-specific-contribution-guidelines): procedures or guides specific to the development conventions of nf-core/bulkvariantcalling.

> [!NOTE]
> If you need help using or modifying nf-core/bulkvariantcalling, ask on the nf-core Slack [#bulkvariantcalling](https://nfcore.slack.com/channels/bulkvariantcalling) channel ([join our Slack here](https://nf-co.re/join/slack)).
...
- [ ] Check whether a GitHub [issue](https://github.com/nf-core/bulkvariantcalling/issues) about your idea already exists. If an issue does not exist, create one so that others are aware you are working on it.
- [ ] [Fork](https://help.github.com/en/github/getting-started-with-github/fork-a-repo) the [nf-core/bulkvariantcalling repository](https://github.com/nf-core/bulkvariantcalling) to your GitHub account.
...
For further information and help, see the [nf-core/bulkvariantcalling documentation](https://nf-co.re/bulkvariantcalling/usage) or ask on the nf-core [#bulkvariantcalling](https://nfcore.slack.com/channels/bulkvariantcalling) Slack channel ([join our Slack here](https://nf-co.re/join/slack)).

### GitHub Codespaces

You can contribute to nf-core/bulkvariantcalling without installing a local development environment on your machine by using [GitHub Codespaces](https://github.com/codespaces).
...
To get started, open the repository in [Codespaces](https://github.com/nf-core/bulkvariantcalling/codespaces).
...
nf-core semi-standardises how you write code and other contributions to make the nf-core/bulkvariantcalling code and processing logic more understandable for new contributors and to ensure quality.
